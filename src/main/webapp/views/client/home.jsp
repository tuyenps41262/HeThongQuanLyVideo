...
<body>
    ...
    <form action="${pageContext.request.contextPath}/" method="post" class="d-flex justify-content-end">
        <div class="input-group" style="max-width: 400px;">
            <input type="text" class="form-control" id="keyword" name="keyword" placeholder="Tìm kiếm video..." required>
					...
					<div class="card p-2 position-relative">
						...
						<div class="mx-2 my-0">
							<c:if test="${not empty sessionScope.currentUser}">
						  		<a href="${pageContext.request.contextPath}/likeVideo?id=${video.id}" class="btn btn-primary ${listLiked.contains(video.id)?'d-none':''}">Thích</a> 
								<a href="${pageContext.request.contextPath}/likeVideo?id=${video.id}" class="btn btn-danger ${listLiked.contains(video.id)?'':'d-none'}">Bỏ thích</a> 
